...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    //>> perfect-hotels-slider Slider Start <<//
    //>> Flag Slider Start <<//
    if ($(".perfect-hotels-slider").length > 0) {
      const flagSlider = new Swiper(".perfect-hotels-slider", {
        spaceBetween: 30,
        speed: 2000,
        loop: true,
        centeredSlides: true,
        ...
        navigation: {
          nextEl: ".swiper-button-next", // Right arrow selector
          prevEl: ".swiper-button-prev", // Left arrow selector
        },
        breakpoints: {
          1199: {
            slidesPerView: 4,
